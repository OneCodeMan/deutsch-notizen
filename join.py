...
lesson_files = [f for f in listdir() if f.endswith('.md')]

for lesson_file in lesson_files:
    input_file = codecs.open(lesson_file, mode='r', encoding='utf-8')
...
all_lessons_html = open('all_lessons.html', 'w', encoding='utf-8')
